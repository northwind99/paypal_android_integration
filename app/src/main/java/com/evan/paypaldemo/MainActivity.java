...
import com.evan.paypaldemo.paypalintegration.PayPalConfig;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void getPayment(String paymentAmount) {
        ...
        PayPalPayment payment = new PayPalPayment(new BigDecimal(String.valueOf(paymentAmount)), "CAD", "Order Total",
